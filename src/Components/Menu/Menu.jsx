...
const Menu = ({ variants, onClick }) => {
  ...
  return (
    <div>
      <button onClick={onClick} className="cross">
        <AiOutlineClose />
      </button>
      ...
      <div className="menu-container">
        ...
        {formState === 1 && (
          <div className="menu-options">
            ...
            <select
              ...
              // }}
            >
              <option value={"default"} sx={{ fontSize: 14 }}>
                <em>Select a model</em>
              </option>
              {Object.keys(variants).map((item, idx) => (
                <option key={idx} value={item} sx={{ fontSize: 12 }}>
                  {item}
                </option>
              ))}
            </select>
        ...
        {formState === 2 && (
          <div className="menu-items-container custom-scroller">

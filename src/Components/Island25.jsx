...
export default function Islandmodels(props) {
  const { nodes, materials } = useGLTF("./models/island25.glb");
  ...
  return (
    <group {...props} dispose={null} scale={12} position={[0, -2, 0]}>
      ...
      <mesh
        ...
        material={materials.Carpaint_Simple_grey__0}
        position={[2.28, 1.041, 0]}
      />
      <mesh
        name='Flooring'
      ...
      <group position={[0.49, 1.337, 0]} scale={[1, 0.83, 1]}>
        <mesh
          ...
          material={materials.Leather_white_16_50cm__01}
        />
        <mesh
          name='Primary Interior'
          ref={primIntRef}
      ...
      <mesh
        ...
        position={[2.114, 0.967, -1.128]}
        scale={[1.054, 1.172, 1]}
      />
      <mesh
        geometry={nodes.Ski_Store.geometry}
        material={materials.Plastic_Simple_Blurry_Black__0}
        position={[1.554, 0.647, 0]}
      ...
      <group position={[0.623, 0.607, 0]} scale={[1, 1, 1.01]}>
        ...
        <mesh
          ...
          material={materials.Plastic_Metallic_Black__0_2}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials.Material__1257}
        />
        <mesh
        ...
        <mesh
          ...
          material={materials.Material__1245}
        />
        <mesh
          geometry={nodes["Z-Misc_26"].geometry}
          material={materials.Material__1233}
        />
        <mesh
          geometry={nodes["Z-Misc_27"].geometry}
          material={materials.Material__1292}
        />
        <mesh
          geometry={nodes["Z-Misc_28"].geometry}
          material={materials.Material__1304}
        />
        <mesh
          geometry={nodes["Z-Misc_29"].geometry}
          material={materials.Material__1316}
        />
        <mesh
          name='Primary Interior'
          ref={primIntRef}
        ...
        <mesh
          ...
          material={materials.Plastic_Metallic_Black__0_3}
        />
      </group>
      <group position={[0.623, 0.607, 0]} scale={[1, 1, 1.01]}>
        <mesh
        ...
        <mesh geometry={nodes.Railings_3.geometry} material={materials.Metal} />
        <mesh geometry={nodes.Railings_4.geometry} material={materials.Metal} />
      </group>
      <mesh
        geometry={nodes.Black_Interior.geometry}
...
useGLTF.preload("./models/island25.glb");
